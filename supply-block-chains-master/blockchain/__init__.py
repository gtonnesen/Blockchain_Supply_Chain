...
import json
import requests  # enables http communication between nodes as well as communication between nodes and the web app

bc_app = Flask(__name__)  # instantiate flask app
...
def get_chain():
    """url that responds with the node's blockchain information upon request.
    more specifically a dictionary with {length of chain, list of blocks in the chain,
     and a list of addresses of nodes in the network"""
